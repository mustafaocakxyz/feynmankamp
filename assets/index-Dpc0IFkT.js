 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Gx=_.forwardRef(({color:i="currentColor",size:r=24,strokeWidth:o=2,absoluteStrokeWidth:c,className:f="",children:h,iconNode:b,...T},x)=>_.createElement("svg",{ref:x,...qx,width:r,height:r,stroke:i,strokeWidth:c?Number(o)*24/Number(r):o,className:Dm("lucide",f),...!h&&!Hx(T)&&{"aria-hidden":"true"},...T},[...b.map(([p,w])=>_.createElement(p,w)),...Array.isArray(h)?h:[h]]));/**
 * @license lucide-react v0.542.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const sy=[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]],Nm=ne("video",sy);var li={},Yh;function fy(){if(Yh)return li;Yh=1,Object.defineProperty(li,"__esModule",{value:!0}),li.parse=b,li.serialize=p;const i=/^[\u0021-\u003A\u003C\u003E-\u007E]+$/,r=/^[\u0021-\u003A\u003C-\u007E]*$/,o=/^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i,c=/^[\u0020-\u003A\u003D-\u007E]*$/,f=Object.prototype.toString,h=(()=>{const k=function(){};return k.prototype=Object.create(null),k})();function b(k,B){const R=new h,L=k.length;if(L<2)return R;const G=(B==null?void 0:B.decode)||w;let H=0;do{const V=k.indexOf("=",H);if(V===-1)break;const q=k.indexOf(";",H),F=q===-1?L:q;if(V>F){H=k.lastIndexOf(";",V-1)+1;continue}const Z=T(k,H,V),nt=x(k,V,Z),J=k.slice(Z,nt);if(R[J]===void 0){let St=T(k,V+1,F),yt=x(k,F,St);const $t=G(k.slice(St,yt));R[J]=$t}H=F+1}while(H<L);return R}function T(k,B,R){do{const L=k.charCodeAt(B);if(L!==32&&L!==9)return B}while(++B<R);return R}function x(k,B,R){for(;B>R;){const L=k.charCodeAt(--B);if(L!==32&&L!==9)return B+1}return R}function p(k,B,R){const L=(R==null?void 0:R.encode)||encodeURIComponent;if(!i.test(k))throw new TypeError(`argument name is invalid: ${k}`);const G=L(B);if(!r.test(G))throw new TypeError(`argument val is invalid: ${B}`);let H=k+"="+G;if(!R)return H;if(R.maxAge!==void 0){if(!Number.isInteger(R.maxAge))throw new TypeError(`option maxAge is invalid: ${R.maxAge}`);H+="; Max-Age="+R.maxAge}if(R.domain){if(!o.test(R.domain))throw new TypeError(`option domain is invalid: ${R.domain}`);H+="; Domain="+R.domain}if(R.path){if(!c.test(R.path))throw new TypeError(`option path is invalid: ${R.path}`);H+="; Path="+R.path}if(R.expires){if(!U(R.expires)||!Number.isFinite(R.expires.valueOf()))throw new TypeError(`option expires is invalid: ${R.expires}`);H+="; Expires="+R.expires.toUTCString()}if(R.httpOnly&&(H+="; HttpOnly"),R.secure&&(H+="; Secure"),R.partitioned&&(H+="; Partitioned"),R.priority)switch(typeof R.priority=="string"?R.priority.toLowerCase():void 0){case"low":H+="; Priority=Low";break;case"medium":H+="; Priority=Medium";break;case"high":H+="; Priority=High";break;default:throw new TypeError(`option priority is invalid: ${R.priority}`)}if(R.sameSite)switch(typeof R.sameSite=="string"?R.sameSite.toLowerCase():R.sameSite){case!0:case"strict":H+="; SameSite=Strict";break;case"lax":H+="; SameSite=Lax";break;case"none":H+="; SameSite=None";break;default:throw new TypeError(`option sameSite is invalid: ${R.sameSite}`)}return H}function w(k){if(k.indexOf("%")===-1)return k;try{return decodeURIComponent(k)}catch{return k}}function U(k){return f.call(k)==="[object Date]"}return li}fy();/**
 * react-router v7.5.1
 *
...
`,B5=()=>{const i=pr(),r=()=>{i("/math")},o=()=>{i("/problem")};return m.jsxs(C5,{children:[m.jsx(U5,{children:"Hangi kampla ilgileniyorsun?"}),m.jsxs(N5,{children:[m.jsx(Y5,{onClick:r,children:m.jsx(Xh,{children:m.jsxs(Qh,{children:[m.jsxs(Kh,{children:[m.jsxs(Vh,{children:[m.jsx(Zh,{children:"İlk 12 Konu | +10 Net Kampı"}),m.jsx($h,{children:"Toplam 9 kişi satın aldı"}),m.jsx(Jh,{children:"Derece öğrencisinden ilk 12 konu özet anlatım + çıkmış soru çözümü."})]}),m.jsx(Wh,{children:"📅 29 Kasım, 18.00 - 21.30"})]}),m.jsx(Fh,{children:m.jsx(ay,{})})]})})}),m.jsx(tp,{style:{animationDelay:"1.4s"},onClick:o,children:m.jsx(Xh,{children:m.jsxs(Qh,{children:[m.jsxs(Kh,{children:[m.jsxs(Vh,{children:[m.jsx(Zh,{children:"Problemler Kampı"}),m.jsx($h,{children:"Toplam 14 kişi satın aldı"}),m.jsx(Jh,{children:"Derece öğrencisi ile problemlerin çözüm yollarını öğren ve çıkmış sorularla pratik yap."})]}),m.jsx(Wh,{children:"📅 30 Kasım, 18.00 - 21.30"})]}),m.jsx(Fh,{children:m.jsx(uy,{})})]})})})]})]})},H5=O.div`
  min-height: 100vh;
  background: linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 25%, #0f0f0f 50%, #1a1a1a 75%, #0a0a0a 100%);
  display: flex;
  flex-direction: column;
...
`,Sb=()=>m.jsx(bb,{children:m.jsx(vb,{children:"Kontenjanlarımız dolmuştur, ilginiz için teşekkürler."})});function Tb(){const i=pr(),r=Ha();return _.useEffect(()=>{const o=sessionStorage.redirect;if(delete sessionStorage.redirect,o&&o!==r.href){const c=new URL(o).pathname;i(c,{replace:!0})}},[i,r]),m.jsxs(t5,{children:[m.jsx(Ue,{path:"/",element:m.jsx(B5,{})}),m.jsx(Ue,{path:"/paragraph",element:m.jsx(X5,{})}),m.jsx(Ue,{path:"/math",element:m.jsx($5,{})}),m.jsx(Ue,{path:"/math-foundation-program",element:m.jsx(p2,{})}),m.jsx(Ue,{path:"/math-problem-program",element:m.jsx(N2,{})}),m.jsx(Ue,{path:"/yks-program",element:m.jsx(K2,{})}),m.jsx(Ue,{path:"/application",element:m.jsx(tb,{})}),m.jsx(Ue,{path:"/social-proof",element:m.jsx(hb,{})}),m.jsx(Ue,{path:"/problem",element:m.jsx(yb,{})}),m.jsx(Ue,{path:"/we-are-full",element:m.jsx(Sb,{})})]})}function zb(){return m.jsx(w5,{children:m.jsx(Tb,{})})}Cg.createRoot(document.getElementById("root")).render(m.jsx(_.StrictMode,{children:m.jsx(zb,{})}));

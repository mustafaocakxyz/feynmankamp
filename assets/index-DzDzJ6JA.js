...
`,H5=()=>{const i=pr(),r=()=>{i("/math")},o=()=>{i("/problem")};return m.jsxs(C5,{children:[m.jsx(U5,{children:"Hangi kampla ilgileniyorsun?"}),m.jsxs(N5,{children:[m.jsx(Y5,{onClick:r,children:m.jsx(Xh,{children:m.jsxs(Qh,{children:[m.jsxs(Kh,{children:[m.jsxs(Vh,{children:[m.jsx(Zh,{children:"İlk 12 Konu | +10 Net Kampı"}),m.jsx($h,{children:"Toplam 6 kişi satın aldı"}),m.jsx(Jh,{children:"Derece öğrencisinden ilk 12 konu özet anlatım + çıkmış soru çözümü."})]}),m.jsx(Wh,{children:"📅 29 Kasım, 18.00 - 21.30"})]}),m.jsx(Fh,{children:m.jsx(ay,{})})]})})}),m.jsx(tp,{style:{animationDelay:"1.4s"},onClick:o,children:m.jsx(Xh,{children:m.jsxs(Qh,{children:[m.jsxs(Kh,{children:[m.jsxs(Vh,{children:[m.jsx(Zh,{children:"Problemler Kampı"}),m.jsx($h,{children:"Toplam 6 kişi satın aldı"}),m.jsx(Jh,{children:"Derece öğrencisi ile problemlerin çözüm yollarını öğren ve çıkmış sorularla pratik yap."})]}),m.jsx(Wh,{children:"📅 30 Kasım, 18.00 - 21.30"})]}),m.jsx(Fh,{children:m.jsx(uy,{})})]})})})]})]})},B5=O.div`
  min-height: 100vh;
  background: linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 25%, #0f0f0f 50%, #1a1a1a 75%, #0a0a0a 100%);
  display: flex;
  flex-direction: column;

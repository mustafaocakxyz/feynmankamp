 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var fh;function dg(){return fh||(fh=1,function(i){function r(_,Q){var I=_.length;_.push(Q);t:for(;0<I;){var ot=I-1>>>1,x=_[ot];if(0<f(x,Q))_[ot]=Q,_[I]=x,I=ot;else break t}}function o(_){return _.length===0?null:_[0]}function c(_){if(_.length===0)return null;var Q=_[0],I=_.pop();if(I!==Q){_[0]=I;t:for(var ot=0,x=_.length,Y=x>>>1;ot<Y;){var X=2*(ot+1)-1,V=_[X],P=X+1,st=_[P];if(0>f(V,I))P<x&&0>f(st,V)?(_[ot]=st,_[P]=I,ot=P):(_[ot]=V,_[X]=I,ot=X);else if(P<x&&0>f(st,I))_[ot]=st,_[P]=I,ot=P;else break t}}return Q}function f(_,Q){var I=_.sortIndex-Q.sortIndex;return I!==0?I:_.id-Q.id}if(i.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var h=performance;i.unstable_now=function(){return h.now()}}else{var v=Date,T=v.now();i.unstable_now=function(){return v.now()-T}}var y=[],m=[],E=1,U=null,O=3,H=!1,R=!1,L=!1,G=!1,B=typeof setTimeout=="function"?setTimeout:null,K=typeof clearTimeout=="function"?clearTimeout:null,q=typeof setImmediate<"u"?setImmediate:null;function F(_){for(var Q=o(m);Q!==null;){if(Q.callback===null)c(m);else if(Q.startTime<=_)c(m),Q.sortIndex=Q.expirationTime,r(y,Q);else break;Q=o(m)}}function Z(_){if(L=!1,F(_),!R)if(o(y)!==null)R=!0,nt||(nt=!0,qt());else{var Q=o(m);Q!==null&&Gt(Z,Q.startTime-_)}}var nt=!1,J=-1,St=5,xt=-1;function $t(){return G?!0:!(i.unstable_now()-xt<St)}function ne(){if(G=!1,nt){var _=i.unstable_now();xt=_;var Q=!0;try{t:{R=!1,L&&(L=!1,K(J),J=-1),H=!0;var I=O;try{e:{for(F(_),U=o(y);U!==null&&!(U.expirationTime>_&&$t());){var ot=U.callback;if(typeof ot=="function"){U.callback=null,O=U.priorityLevel;var x=ot(U.expirationTime<=_);if(_=i.unstable_now(),typeof x=="function"){U.callback=x,F(_),Q=!0;break e}U===o(y)&&c(y),F(_)}else c(y);U=o(y)}if(U!==null)Q=!0;else{var Y=o(m);Y!==null&&Gt(Z,Y.startTime-_),Q=!1}}break t}finally{U=null,O=I,H=!1}Q=void 0}}finally{Q?qt():nt=!1}}}var qt;if(typeof q=="function")qt=function(){q(ne)};else if(typeof MessageChannel<"u"){var Ve=new MessageChannel,Ke=Ve.port2;Ve.port1.onmessage=ne,qt=function(){Ke.postMessage(null)}}else qt=function(){B(ne,0)};function Gt(_,Q){J=B(function(){_(i.unstable_now())},Q)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(_){_.callback=null},i.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):St=0<_?Math.floor(1e3/_):5},i.unstable_getCurrentPriorityLevel=function(){return O},i.unstable_next=function(_){switch(O){case 1:case 2:case 3:var Q=3;break;default:Q=O}var I=O;O=Q;try{return _()}finally{O=I}},i.unstable_requestPaint=function(){G=!0},i.unstable_runWithPriority=function(_,Q){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var I=O;O=_;try{return Q()}finally{O=I}},i.unstable_scheduleCallback=function(_,Q,I){var ot=i.unstable_now();switch(typeof I=="object"&&I!==null?(I=I.delay,I=typeof I=="number"&&0<I?ot+I:ot):I=ot,_){case 1:var x=-1;break;case 2:x=250;break;case 5:x=1073741823;break;case 4:x=1e4;break;default:x=5e3}return x=I+x,_={id:E++,callback:Q,priorityLevel:_,startTime:I,expirationTime:x,sortIndex:-1},I>ot?(_.sortIndex=I,r(m,_),o(y)===null&&_===o(m)&&(L?(K(J),J=-1):L=!0,Gt(Z,I-ot))):(_.sortIndex=x,r(y,_),R||H||(R=!0,nt||(nt=!0,qt()))),_},i.unstable_shouldYield=$t,i.unstable_wrapCallback=function(_){var Q=O;return function(){var I=O;O=Q;try{return _.apply(this,arguments)}finally{O=I}}}}(jo)),jo}var dh;function hg(){return dh||(dh=1,Co.exports=dg()),Co.exports}var Uo={exports:{}},ee={};/**
 * @license React
...
`,k5=()=>{const i=mr(),r=()=>{i("/math")};return p.jsxs(x5,{children:[p.jsx(v5,{children:"Hangi kampla ilgileniyorsun?"}),p.jsx(b5,{children:p.jsx(T5,{onClick:r,children:p.jsx(z5,{children:p.jsxs(E5,{children:[p.jsxs(w5,{children:[p.jsxs(M5,{children:[p.jsx(A5,{children:"İlk 12 Konu | +10 Net Kampı"}),p.jsx(O5,{children:"Toplam 22 kişi satın aldı"}),p.jsx(R5,{children:"Derece öğrencisinden ilk 12 konu özet anlatım + çıkmış soru çözümü."})]}),p.jsx(_5,{children:"📅 16 Kasım, 18.00 - 21.30"})]}),p.jsx(D5,{children:p.jsx(Gy,{})})]})})})})]})},C5=C.div`
  min-height: 100vh;
  background: linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 25%, #0f0f0f 50%, #1a1a1a 75%, #0a0a0a 100%);
  display: flex;
  flex-direction: column;
...
`,B2=()=>{const i=mr(),r=()=>{i("/application")},o=()=>{i("/social-proof")};return p.jsxs(D2,{children:[p.jsxs(k2,{children:[p.jsxs(C2,{children:["7 Ayda ",p.jsx(j2,{children:"İlk 30.000"})]}),p.jsx(U2,{children:"Sıfırdan YKS Programı"})]}),p.jsxs(N2,{children:[p.jsx(Xu,{style:{animationDelay:"0.6s"},children:p.jsxs(Qu,{children:[p.jsx(Vu,{children:p.jsx(Vy,{})}),p.jsx(Ku,{children:"7 Ay Boyunca Mustafa Ocak ile 1 - 1 Görüşme"})]})}),p.jsx(Xu,{style:{animationDelay:"0.8s"},children:p.jsxs(Qu,{children:[p.jsx(Vu,{children:p.jsx(Uy,{})}),p.jsx(Ku,{children:"Her günün programı en ince detayına kadar hazırlanır"})]})}),p.jsx(Xu,{style:{animationDelay:"1s"},children:p.jsxs(Qu,{children:[p.jsx(Vu,{children:p.jsx(Yy,{})}),p.jsx(Ku,{children:"Mustafa Ocak'ın da bulunduğu VIP Telegram grubu"})]})}),p.jsx(Xu,{style:{animationDelay:"1.2s"},children:p.jsxs(Qu,{children:[p.jsx(Vu,{children:p.jsx(cs,{})}),p.jsx(Ku,{children:"Kişiye özel düzenli denemeler ve ders bitirme kampları"})]})})]}),p.jsxs(Y2,{children:[p.jsx(H2,{onClick:o,children:"Başaranları Gör"}),p.jsx(Bm,{onClick:r,children:"Programa Başvur"})]})]})},q2=C.div`
  min-height: 100vh;
  background: linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 25%, #0f0f0f 50%, #1a1a1a 75%, #0a0a0a 100%);
  display: flex;
  flex-direction: column;
